...
function centralImportValidationHtml(a){
 ...
 return `<div class="import-validation-sheet"><h4>Contrôle avant validation</h4><div class="summary-grid">${cards.join('')}</div><p class="hint">Vérifiez ces informations. Rien n’est enregistré avant votre validation finale dans le module concerné.</p></div>`;
}
