...
(()=>{'use strict';
const KEY='pst_cleaning_rooms_v103', CK='pst_cleaning_checks_v103', SELKEY='pst_cleaning_room_selection_v147_53', CONFIG_VERSION='147.79';
...
async function deleteHistoryCheck(id){
 ...
 try{
  ...
  // V147.77 : suppression définitive robuste. On mémorise toutes les formes d'identifiant
